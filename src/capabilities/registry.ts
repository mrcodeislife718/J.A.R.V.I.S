...
const definitions: CapabilityDefinition[] = [
  ...
  define("biomedical.evidence-graph", "Biomedical evidence graph", "Connect targets, pathways, diseases, interventions, studies, and outcomes.", "moderate"),
  ...
  define("biomedical.hypothesis-draft", "Hypothesis drafting", "Draft testable research hypotheses for qualified researchers.", "high"),
  define("biomedical.assay-analyze", "Assay analysis", "Analyze supplied assay data with explicit statistical limitations.", "moderate", ["analytics.compute"]),
  define("biomedical.ip-landscape", "IP landscape", "Map patents, claims, assignees, and potential white space.", "moderate", ["ip.search"]),
  define("biomedical.regulatory-map", "Regulatory mapping", "Map translational and regulatory pathways without legal or clinical authorization.", "moderate"),
  define("biomedical.nanoparticle-evaluate", "Nanoparticle evaluation", "Evaluate payload, targeting, distribution, clearance, and toxicity evidence.", "high"),
